...
def main():
    ...
    p_align.add_argument(
        ...
        "--moving_file",
        required=True,
        help="Input file path for IF image (e.g., .tiff)",
    )
    p_align.add_argument(
    ...
    p_align.add_argument(
        ...
        type=int,
        help="DAPI channel index for moving image",
    )
    p_align.add_argument(
        "--series_fixed",
        type=int,
        default=0,
        help="Series index for fixed image (default: 0)",
    )
    p_align.add_argument(
        "--series_moving",
        type=int,
        default=0,
        help="Series index for moving image (default: 0)",
    )
    ...
    p_align.add_argument(
        "--find_poorly_aligned_regions",
        type=bool,
        default=False,
        help="Whether to find poorly aligned regions (default: False)",
    )
    p_align.add_argument(
        "--apply_mirage_correction",
        type=bool,
        default=True,
        help="Whether to apply mirage correction to SIFT aligned images (default: False)",
    )
